		...
		<div class="space-y-6 sm:space-y-5">
			...
			<div class="space-y-6 sm:space-y-5">
				<div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
					<label for="name" class="block text-md font-medium text-gray-700 sm:mt-px sm:pt-2">Job</label>
					<div class="mt-1 sm:col-span-3 sm:mt-0">
						<input
							...
							disabled
							class="p-2 inline mb-4 lg:mb-0 w-full max-w-lg bg-gray-50 rounded-md border border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:max-w-xs sm:text-sm"
						/>
						<a
				...
				<div class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
					<label for="createdAt" class="block text-md font-medium text-gray-700 sm:mt-px sm:pt-2">Datetime</label>
					<div class="mt-1 sm:col-span-3 sm:mt-0">
						<input
							type="text"
							name="createdAt"
