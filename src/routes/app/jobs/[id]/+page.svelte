...
<form class="space-y-8 divide-y divide-gray-200" method="POST" action="?/update">
		...
		<div class="space-y-6 sm:space-y-5">
			...
			<div class="space-y-6 sm:space-y-5">
				...
				<div
					class="sm:grid sm:grid-cols-4 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5"
				>
					<label for="enabled" class="block text-md font-medium text-gray-700 sm:mt-px sm:pt-2">
						Enabled
					</label>
					<div class="mt-1 sm:col-span-2 sm:mt-0">
